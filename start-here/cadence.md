...
- [ ] Sprint length is defined
- [ ] Daily standups are scheduled
- [ ] Sprint planning session is scheduled
- [ ] Review and retrospective sessions are scheduled
- [ ] Time allocation includes learning/experimentation
- [ ] Cadence is documented and shared with team
...
- [ ] Sprint length is defined
- [ ] All regular events are scheduled
- [ ] Time allocation includes learning
- [ ] Cadence is documented and communicated
...
> 📝 **Note**: Cadence should evolve as your project progresses from Decide → Build → Launch
> 💡 **Tip**: Start with shorter sprints and lengthen if needed, rather than starting too long
