...
1. Start in [Start Here](GETTING-STARTED.md).
2. Align on shared concepts and definitions.
3. Learn the structure of a strong learning cycle.
4. Run learning cycles in SwiftCNS.
...
Learn more about SwiftRacks at [https://swiftracks.com](https://swiftracks.com).
...
Begin with [Start Here](GETTING-STARTED.md).