...
1. **Is your problem specific enough?**
   ...
   - [ ] Somewhat specific
   - [ ] Too vague (needs refinement)

2. **Have you validated the problem with users?**
   - [ ] Yes, through interviews
   - [ ] Somewhat, through surveys
   - [ ] No, not yet (do this first)

3. **Is the problem worth solving?**
   - [ ] Yes, all criteria met
   - [ ] Maybe, some criteria met
   - [ ] No, criteria not met (reconsider)
...
You might proceed but be aware of moderate risk.
